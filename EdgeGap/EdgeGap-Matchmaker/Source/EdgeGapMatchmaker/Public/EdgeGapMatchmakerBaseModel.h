...
namespace EdgeGap
{
    ...
    struct EDGEGAPMATCHMAKER_API FEdgeGapBaseModel
    {
        virtual ~FEdgeGapBaseModel() {}
    ...
    struct EDGEGAPMATCHMAKER_API FEdgeGapRequestCommon : FEdgeGapBaseModel
    {
    };

    struct EDGEGAPMATCHMAKER_API FEdgeGapResultCommon : FEdgeGapBaseModel
    {
        FString RequestId;
    };

    struct EDGEGAPMATCHMAKER_API FJsonKeeper : public FEdgeGapBaseModel
    {
    private:
